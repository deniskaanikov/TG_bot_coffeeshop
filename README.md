...
В рамках учебной программы я создал телеграм-бот, формирующий предложение по посещению конкретного кафе на основе выбранного пользователем напитка и диапазона цен для него.
